...
import 'package:flutter_movies/screens/castncrew.dart';
...
class ScrollingArtists extends StatefulWidget {
  ...
  const ScrollingArtists(
      {super.key, this.themeData, this.api, this.title, this.tapButtonText, this.onTap});
  @override
                            ...
                            child: ClipRRect(
                              ...
                              child: credits!.cast![index].profilePath ==
                                ...
                                fit: BoxFit.cover,
                                  ...
                                  : FadeInImage(
                                image: NetworkImage(
                                    '${TMDB_BASE_IMAGE_URL}w500/${credits!.cast![index]
                                            .profilePath!}'),
                                fit: BoxFit.cover,
                                placeholder: const AssetImage(
                                    'assets/images/loading.gif'),
